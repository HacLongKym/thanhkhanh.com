...
Plugin URI: http://www.superwebtricks.com/facebook-page-wordpress-plugin
...
class ShowebloginFacebookPagePlugin extends WP_Widget 
{
    ...
    function widget($args, $instance)
    {
        ...
        <?php  if ( $title ) {  ?> <h2 class="widget-title"><?php echo $title; ?></h2> <?php }  ?>
            <div id="fb-root"></div><script>(function(d, s, id) {  var js, fjs = d.getElementsByTagName(s)[0];  if (d.getElementById(id)) return;  js = d.createElement(s); js.id = id;  js.src = "//connect.facebook.net/<?php echo $language; ?>/sdk.js#xfbml=1&version=v2.7&appId=214112425590307";
  fjs.parentNode.insertBefore(js, fjs);}(document, 'script', 'facebook-jssdk'));</script>			
		...
		<!-- Showeblogin Facebook Page Plugin HELP - http://www.superwebtricks.com/facebook-page-wordpress-plugin/ 21-07-2016 -->
		   </section>
     <?php
    }
