...
class MaxGalleriaMediaLib {
  ...
  public function __construct() {
	...
	public function set_global_constants() {	
		...
		define('MAXGALLERIA_MEDIA_LIBRARY_VERSION_NUM', '3.1.7');
...
//      wp_schedule_event( time(), 'daily', 'new_folder_check' );
  ...
  public function setup_hooks() {
    ...
    add_action('wp_ajax_nopriv_mgmlp_update_folder_parent', array($this, 'mgmlp_update_folder_parent'));
    add_action('wp_ajax_mgmlp_update_folder_parent', array($this, 'mgmlp_update_folder_parent'));				
